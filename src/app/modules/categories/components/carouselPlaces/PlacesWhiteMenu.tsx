...
const sectionRefs: Record<string, React.RefObject<HTMLDivElement | null>> =
  categoriesToShow.reduce((acc, cat) => {
    acc[cat.id] = React.createRef<HTMLDivElement>();
    return acc;
      ...
      <div className="flex gap-6 relative">
        <div className="flex-1 overflow-y-auto">
          {categoriesToShow.map((cat) => {
            ...
            return (
              <div key={cat.id} ref={sectionRefs[cat.id]} className="mb-10 scroll-mt-24">
                ...
                {filteredPlaces.length > 0 ? (
                  <CarouselPlaces
                    ...
                    navigationPrevRef={prevRef as React.RefObject<HTMLDivElement>}
                    navigationNextRef={nextRef as React.RefObject<HTMLDivElement>}
                  />
                ) : (
