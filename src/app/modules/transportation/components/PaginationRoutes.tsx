...
interface PaginacionRutasProps {
    totalPages: number;
    currentPage: number;
...
const PaginacionRutas: React.FC<PaginacionRutasProps> = ({
    totalPages,
    currentPage,
    onPageChange,
    onItemsPerPageChange,
}) => {
    const maxPageButtons = 5; // Mostrar 5 botones de página como máximo
    let pageNumbers = [];
...
export default PaginacionRutas;
